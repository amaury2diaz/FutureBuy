<%@ Page Title="Edit Product" Language="C#" MasterPageFile="~/MasterPageAdminMenu.Master" AutoEventWireup="true" CodeBehind="EditProduct.aspx.cs" Inherits="Assignment2.Admin.EditProduct" Theme="General" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        <tr>
            ...
            <td>
                <asp:DropDownList ID="categoryList" runat="server" AutoPostBack="true" /></td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td><asp:Label ID="imageLabel" runat="server" Text="Image" /></td>
            <td><asp:Image ID="image" runat="server" Width="300" /></td>
            <td> <asp:FileUpload ID="pImage" runat="server" /></td>
        </tr>
    </table>
    ...
    <asp:Button ID="editProductButton" runat="server" Text="Edit Product" OnClick="editProductButton_Click" />
</asp:Content>
